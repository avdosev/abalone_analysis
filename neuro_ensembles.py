...
[[
    {'base_estimator': MLPRegressor(hidden_layer_sizes=(n,), solver=s, random_state=42), 'n_estimators':30, 'random_state':42}
...
params = list(itertools.chain.from_iterable(
[[
    {'base_estimator': MLPRegressor(hidden_layer_sizes=(n,), solver='lbfgs', activation=x, random_state=42),
